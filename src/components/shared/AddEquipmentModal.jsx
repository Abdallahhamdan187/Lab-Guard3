...
const CATEGORIES = [
  "Microcontrollers", "Measurement Tools", "Power Supply",
  "3D Printing", "Soldering", "Networking", "Sensors",
  "Robotics", "Optics", "Chemistry", "Mechanical", "Other",
];

const LOCATIONS = [
  "Lab A - Shelf 1", "Lab A - Shelf 2", "Lab A - Shelf 3",
  "Lab B - Station 1", "Lab B - Station 2", "Lab B - Station 5",
  "Lab C - Cabinet 1", "Lab C - Cabinet 2",
  "Lab D - Storage", "Storage Room",
];
