...
const weeklyData = [
  { day: "Mon", requests: 12, approvals: 10, denials: 2 },
  { day: "Tue", requests: 15, approvals: 13, denials: 2 },
  { day: "Wed", requests: 10, approvals: 9,  denials: 1 },
  { day: "Thu", requests: 18, approvals: 15, denials: 3 },
  { day: "Fri", requests: 8,  approvals: 7,  denials: 1 },
];

const hourlyData = [
  { hour: "8am", requests: 2 }, { hour: "9am", requests: 8 },  { hour: "10am", requests: 14 },
  { hour: "11am", requests: 11 },{ hour: "12pm", requests: 5 }, { hour: "1pm", requests: 3 },
  { hour: "2pm", requests: 12 }, { hour: "3pm", requests: 16 }, { hour: "4pm", requests: 9 },
  { hour: "5pm", requests: 4 },
];
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        <StatCard title="Pending Approvals"  value={pendingList.length}  icon={Clock}      color="#f39c12" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={hourlyData} margin={{ bottom: 20 }}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            {["Available","In Use","Maintenance","Reserved"].map(status => {
              ...
              const pct   = Math.round((count / mockEquipment.length) * 100);
              const colors = { Available:"#27ae60","In Use":"#3498db",Maintenance:"#f39c12",Reserved:"#9b59b6" };
              return (
                <div key={status}>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="overflow-x-auto">
          <Table>
            ...
            <TableBody>
              {pendingList.length > 0 ? pendingList.map(txn => (
